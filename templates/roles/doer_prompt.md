...
3.  **Adherence to Project Knowledge**: You MUST uphold all architectural invariants and coding standards defined in the project's `GEMINI.md` and `designs/` documents.
